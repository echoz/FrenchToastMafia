class CarNPC extends NPC {
	...
	/*
		Instructions on entering car
		new Subtitle("Press [W] or [S] to move forward or reverse.", 3);
		new Subtitle("Press [A] or [D] to turn left or right.", 3);
		new Subtitle("Press [SpaceBar] to brake.", 3);
		new Subtitle("Press [G] to get out the car.", 3);
		new Subtitle("Press [F] to on/off light.", 3);
